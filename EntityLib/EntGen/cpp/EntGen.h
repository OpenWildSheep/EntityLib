...
namespace Ent
{
    namespace Gen
    {
        ...
        struct CreatureGD : HelperObject // Object
        {
            ...
            Ent::Gen::FallData fallData() const;
        ...
        struct FallData : HelperObject // Object
        {
            FallData(Ent::Node* _node): HelperObject(_node) {}
            static constexpr char schemaName[] = "./RuntimeComponents.json#/definitions/FallData";
            static Ent::Node load(Ent::EntityLib& _entlib, std::filesystem::path const& _sourceFile)
            {
                return _entlib.loadFileAsNode(_sourceFile, *_entlib.getSchema(schemaName));
            }
            Ent::Gen::String _comment() const;
            Ent::Gen::Float deadDelayDuringFreeFall() const;
            Ent::Gen::Float fallToFreeFallDelay() const;
            Ent::Gen::Float injuredDelayDuringFall() const;
        };
        ...
        inline Ent::Gen::FallData CreatureGD::fallData() const
        {
            return Ent::Gen::FallData(node->at("fallData"));
        }
        ...
        // FallData
        inline Ent::Gen::String FallData::_comment() const
        {
            return Ent::Gen::String(node->at("_comment"));
        }
        inline Ent::Gen::Float FallData::deadDelayDuringFreeFall() const
        {
            return Ent::Gen::Float(node->at("deadDelayDuringFreeFall"));
        }
        inline Ent::Gen::Float FallData::fallToFreeFallDelay() const
        {
            return Ent::Gen::Float(node->at("fallToFreeFallDelay"));
        }
        inline Ent::Gen::Float FallData::injuredDelayDuringFall() const
        {
            return Ent::Gen::Float(node->at("injuredDelayDuringFall"));
        }
