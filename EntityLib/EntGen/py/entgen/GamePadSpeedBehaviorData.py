...
class GamePadSpeedBehaviorData(HelperObject):
    ...
    @property
    def PostponeNormMax(self):  # type: ()->Float
        return Float(self._node.at("PostponeNormMax"))
    @PostponeNormMax.setter
    def PostponeNormMax(self, val): self.PostponeNormMax.set(val)
    @property
