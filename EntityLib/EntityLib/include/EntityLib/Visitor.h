...
namespace Ent
{
    ...
    public:
        ...
        virtual void inObject([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entering in an object's field
        virtual bool inObjectField([[maybe_unused]] Handler& expl, [[maybe_unused]] char const* _key)
        {
            return true;
        }
        /// Called when exiting an object's field
        virtual void outObjectField([[maybe_unused]] Handler& expl, [[maybe_unused]] char const* _key)
        {
        }
        /// Called when exiting an object
        virtual void outObject([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entering in a union
        virtual void inUnion([[maybe_unused]] Handler& expl, [[maybe_unused]] char const* _type)
        {
        }
        /// Called when exiting a union
        virtual void outUnion([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entering in a Map
        virtual void inMap([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when exiting a Map
        virtual void outMap([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entering in a Map's element (string key)
        virtual void inMapElement([[maybe_unused]] Handler& expl, [[maybe_unused]] char const* _key)
        {
        }
        /// Called when entering in a Map's element (integer key)
        virtual void inMapElement([[maybe_unused]] Handler& expl, [[maybe_unused]] int64_t _key)
        {
        }
        /// Called when exiting a Map's element (Get back to Map)
        virtual void outMapElement([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entering in a Set of primitive
        virtual void inPrimSet([[maybe_unused]] Handler& expl, [[maybe_unused]] Ent::DataType _dataType)
        {
        }
        /// Called when entering in the element of an array
        virtual void inArrayElement([[maybe_unused]] Handler& expl, [[maybe_unused]] size_t _index)
        {
        }
        /// Called when exiting the element of an array
        virtual void outArrayElement([[maybe_unused]] Handler& expl)
        {
        }
        /// Called for each values in a set of primitive
        virtual void key([[maybe_unused]] Handler& expl, [[maybe_unused]] char const* _key)
        {
        }
        /// Called for each values in a set of primitive
        virtual void key([[maybe_unused]] Handler& expl, [[maybe_unused]] int64_t _key)
        {
        }
        /// Called when exiting a set of primitive
        virtual void outPrimSet([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entering in a set of union
        virtual void inUnionSet([[maybe_unused]] Handler& expl)
        {
        }
        ...
        virtual void outUnionSetElement([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when exiting a set of union
        virtual void outUnionSet([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entering in a set of object
        virtual void inObjectSet([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when exiting a set of object
        virtual void outObjectSet([[maybe_unused]] Handler& expl)
        {
        }
        ...
        /// Called when entering in the child of a set of object
        virtual void inObjectSetElement([[maybe_unused]] Handler& expl, [[maybe_unused]] int64_t _key)
        {
        }
        /// Called when exiting the child of a set of object
        virtual void outObjectSetElement([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entering in a simple array
        virtual void inArray([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when exiting in a simple array
        virtual void outArray([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entered in a null Node
        virtual void nullNode([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entered in a bool Node
        virtual void boolNode([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entered in a integer Node
        virtual void intNode([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entered in a float Node
        virtual void floatNode([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entered in a string Node
        virtual void stringNode([[maybe_unused]] Handler& expl)
        {
        }
        /// Called when entered in a entityref Node
        virtual void entityRefNode([[maybe_unused]] Handler& expl)
        {
        }
    };
