...
os.environ["PYTHONPATH"] += ";" + input_path	# we need to add the EntityLibPy module's directory to PYTHONPATH so that stubgen can access it
subprocess.call("pybind11-stubgen.exe EntityLibPy -o %s" % output_path)
print("stubgen done")
