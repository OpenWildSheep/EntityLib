...
PYBIND11_MODULE(EntityLibPy, ent)
{
    ...
    pyProperty
        ...
        .def("copy_into", &Property::copyInto, py::arg("dest"), py::arg("copy_mode"), py::arg("override_value_source") = OverrideValueSource::OverrideOrPrefab, py::arg("copy_root_instance_of") = false)
