...
namespace WRPC
{
    ...
    struct VisitPrint
    {
        ...
        {
            printf("(float) %.2f", _value);
        }
        void operator()(const Vector2& _value)
        {
            printf("(Vector2) (%f, %f)", _value.x, _value.y);
        }
        void operator()(const Vector3i& _value)
        {
            printf("(Vector3i) (%d, %d, %d)", _value.x, _value.y, _value.z);
        }
        void operator()(const Vector3& _value)
        {
            printf("(Vector3) (%f, %f, %f)", _value.x, _value.y, _value.z);
        }
        void operator()(const Quat& _value)
        {
            printf("(Quat) (%f, %f, %f, %f)", _value.x, _value.y, _value.z, _value.w);
        }
        void operator()(const Color& _value)
        {
            printf("(Color) (%f, %f, %f, %f)", _value.r, _value.g, _value.b, _value.a);
        }
        void operator()(const Position& _value)
        {
            printf(
                "(Position) [%d, %d] (%f, %f, %f)", _value.wx, _value.wy, _value.x, _value.y, _value.z);
        }
    ...
    struct VisitEncode
    {
        ...
        VisitEncode(flatbuffers::FlatBufferBuilder& _builder)
            : m_builder(_builder)
        {
        }
