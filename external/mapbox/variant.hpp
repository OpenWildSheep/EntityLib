...
#define VARIANT_VERSION                                                                            \
    (VARIANT_MAJOR_VERSION * 100000) + (VARIANT_MINOR_VERSION * 100) + (VARIANT_PATCH_VERSION)
...
namespace mapbox
{
    namespace util
    {
        ...
        namespace detail
        {
            ...
            struct convertible_type<T, First, Types...>
            {
                static constexpr type_index_t index =
                    std::is_convertible<T, First>::value ?
                        disjunction<std::is_convertible<T, Types>...>::value ? invalid_value :
                                                                               sizeof...(Types) :
            ...
            struct value_traits
            {
                ...
                static constexpr type_index_t index_direct_or_wrapper =
                    is_direct ? direct_index : direct_type<value_type_wrapper, Types...>::index;
            ...
            {
                static const type_index_t value = arg1 >= arg2 ? static_max<arg1, others...>::value :
            ...
            struct variant_helper<T, Types...>
            {
                ...
                VARIANT_INLINE static void
                move(const type_index_t old_type_index, void* old_value, void* new_value)
                {
                ...
                VARIANT_INLINE static void
                copy(const type_index_t old_type_index, const void* old_value, void* new_value)
                {
                    if (old_type_index == sizeof...(Types))
                    {
            ...
            struct unwrapper<recursive_wrapper<T>>
            {
                ...
                static auto apply(recursive_wrapper<T>& obj) -> typename recursive_wrapper<T>::type&
                {
                    return obj.get();
                }
            };
            ...
            struct binary_dispatcher_rhs<F, V, R, T0, T1, Types...>
            {
                ...
                VARIANT_INLINE static R apply(V& lhs, V& rhs, F&& f)
                {
                    ...
                    {
                        return f(
                            unwrapper<T0>::apply(lhs.template get_unchecked<T0>()),
            ...
            struct binary_dispatcher_lhs<F, V, R, T0, T1, Types...>
            {
                ...
                VARIANT_INLINE static R apply(V& lhs, V& rhs, F&& f)
                {
                    ...
                    {
                        return f(
                            unwrapper<T1>::apply(lhs.template get_unchecked<T1>()),
        ...
        {
            static_assert(
                sizeof...(Types) > 0, "Template parameter type list of variant can not be empty.");
            static_assert(
                !detail::disjunction<std::is_reference<Types>...>::value,
                "Variant can not hold reference types. Maybe use std::reference_wrapper?");
            static_assert(
                !detail::disjunction<std::is_array<Types>...>::value,
        ...
        public:
            ...
            template <
                ...
                typename Enable = typename std::enable_if<
                    Traits::is_valid
                    && !std::is_same<variant<Types...>, typename Traits::value_type>::value>::type>
        ...
        public:
            ...
            {
                if (this == &other)
                { // playing safe in release mode, hit assertion in debug.
                    assert(false);
                    return *this;
                }
            ...
            auto VARIANT_INLINE static binary_visit(V const& v0, V const& v1, F&& f) -> decltype(
                detail::binary_dispatcher<F, V, R, Types...>::apply_const(v0, v1, std::forward<F>(f)))
            {
            ...
            auto VARIANT_INLINE static binary_visit(V& v0, V& v1, F&& f) -> decltype(
                detail::binary_dispatcher<F, V, R, Types...>::apply(v0, v1, std::forward<F>(f)))
            {
            ...
            auto VARIANT_INLINE match(Fs&&... fs) const -> decltype(
                variant::visit(*this, ::mapbox::util::make_visitor(std::forward<Fs>(fs)...)))
            {
